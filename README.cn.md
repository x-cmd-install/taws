...
[![x-cmd/install — taws Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/taws.svg?lang=zh)](https://x-cmd.com/install/taws)
...
- **上游仓库**: <https://github.com/huseyinbabal/taws>
- **许可证**: MIT
...
- **Star**: 2,260 · **Fork**: 74 · **开放 issue**: 72 · **贡献者**: 12

## 累计统计

- **发布数**: 21 · **已合并 PR**: 65 · **开放 PR**: 4 · **已关闭 issue**: 63 · **开放 issue**: 9 · **提交数**: 260

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 0 | 2 | 3 | 0 | 1 | 5 |
| last60d | 2026-07-28 | 0 | 4 | 3 | 1 | 1 | 9 |
| 90d | 2026-06-28 | 0 | 4 | 3 | 1 | 1 | 9 |
| last180d | 2026-03-30 | 1 | 9 | 4 | 7 | 4 | 27 |
| 360d | 2025-10-01 | 21 | 65 | 4 | 63 | 9 | 185 |
| last720d | 2024-10-06 | 21 | 65 | 4 | 63 | 9 | 260 |
...
taws 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `taws` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/taws.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T06:06:20Z._
